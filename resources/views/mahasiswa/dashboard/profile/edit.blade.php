        ...
        <form action="/dashboard-mahasiswa/edit" method="post" class="row mx-5 mb-5 pb-3" enctype="multipart/form-data">
            ...
            <div class="col-lg-3 d-flex justify-content-center flex-column align-items-center">
                <div class="ratio bg-secondary-subtle" style="width: 200px; aspect-ratio: 3/4">
                    <img class="w-100 h-100 object-fit-cover" src="{{ asset('storage/' . $mahasiswa->foto) }}"
                        alt="">
                </div>
            ...
            <div class="col-lg-9 row">
                ...
                <div class="col-lg-6 p-3">
                    <label for="alamat">Alamat @error('alamat')
                            <span class="text-danger">({{ $message }})</span>
                        @enderror
                    </label>
                ...
                <div class="col-lg-6 p-3">
                    <label for="telepon">Telepon @error('no_hp')
                            <span class="text-danger">({{ $message }})</span>
                        @enderror
                    </label>
                ...
                <div class="col-lg-6 p-3">
                    ...
                    <input type="text" value="{{ $mahasiswa->jurusan }}" name="jurusan" class="form-control disabled"
                        disabled>
                </div>

                <div class="col-lg-6 p-3">
                    <label for="prodi">Program Studi</label>
                    <input type="text" value="{{ $mahasiswa->prodi }}" name="prodi" class="form-control disabled"
                        disabled>
                </div>
                ...
                <div class="col-lg-4 px-3">
                    <label for="nama_orangtua">Nama Orang Tua @error('nama_orangtua')
                            <span class="text-danger">({{ $message }})</span>
                        @enderror
                    </label>
                    <input type="text" value="{{ $mahasiswa->nama_orangtua }}" name="nama_orangtua"
                        class="form-control">
                </div>

                <div class="col-lg-4 px-3">
                    <label for="alamat_orangtua">Alamat Orang Tu @error('alamat_orangtua')
                            <span class="text-danger">({{ $message }})</span>
                        @enderror
                    </label>
                    <input type="text" value="{{ $mahasiswa->alamat_orangtua }}" name="alamat_orangtua"
                        class="form-control">
                </div>

                <div class="col-lg-4 px-3">
                    <label for="no_hp_orangtua">Telepon Orang Tua @error('no_hp_orangtua')
                            <span class="text-danger">({{ $message }})</span>
                        @enderror
                    </label>
                    <input type="text" value="{{ $mahasiswa->no_hp_orangtua }}" name="no_hp_orangtua"
                        class="form-control">
                </div>
                ...
                <div class="col-lg-6 px-3">
                    ...
                    <input type="text" value="{{ $mahasiswa->dosen->nama ?? '' }} ({{ $mahasiswa->dosen->nip ?? '' }})"
                        name="dosen" class="form-control disabled" disabled>
                </div>

                <div class="col-lg-6 px-3">
                    <label for="kaprodi">Kepala Prodi</label>
                    <input type="text"
                        value="{{ $mahasiswa->kaprodi->nama ?? '' }} ({{ $mahasiswa->kaprodi->nip ?? '' }})"
                        name="kaprodi" class="form-control disabled" disabled>
                </div>

                <div class="col-lg-12 px-3 py-5 d-flex justify-content-end gap-2">
                    <a href="/dashboard-mahasiswa" class="btn btn-danger">Batal</a>
                    <button type="submit" href="/dashboard-mahasiswa/edit" class="btn btn-success">Perbaharui
                        Data</button>
                </div>
            </div>
        </form>
