  ...
  <div class="row mx-5 mb-5 pb-3">
    ...
    <div class="col-lg-9 row">
      ...
      <div class="col-lg-6 px-3">
        ...
        <input type="text" value="{{ $mahasiswa->dosen->nama ?? '' }} ({{ $mahasiswa->dosen->id ?? '' }})" class="form-control disabled" disabled>
      </div>

      <div class="col-lg-6 px-3">
        <label for="kaprodi">Kepala Prodi</label>
        <input type="text" value="{{ $mahasiswa->kaprodi->nama ?? ''}} ({{ $mahasiswa->kaprodi->id ?? '' }})" class="form-control disabled" disabled>
      </div>
