...
@section('dosen-mainbar')
  <div class="m-4 h-auto border w-100">
    ...
    <div class="mx-5 mb-5 pb-3">
      <form action="/dashboard-dosen/report-bimbingan/evaluasi/edit/{{ $evaluasi->id }}" method="post"
        class="d-flex flex-column w-100 gap-3">
        @method('PUT')
        @csrf
          ...
          <div class="card-wrapper w-50">
            ...
            <div class="card">
              <div class="form-floating">
                <textarea autofocus class="form-control" name="solusi" placeholder="Leave a comment here" id="floatingTextarea2"
                  style="height: auto">{{ $evaluasi->solusi }}</textarea>
        ...
        <footer class="d-flex justify-content-end align-items-center gap-2">
          <div class="form-check">
            ...
            <input class="form-check-input" type="checkbox" value="1" id="flexCheckChecked" name="selesai"
              {{ $evaluasi->selesai == 'true' ? 'checked' : '' }}>
