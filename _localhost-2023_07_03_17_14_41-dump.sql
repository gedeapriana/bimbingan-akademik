...
--
-- Host: 127.0.0.1    Database: bimbingan_akademik_2
-- ------------------------------------------------------
...
('19','Emin Prakasa S.T.',NULL,'dosen','RPL','Elektro','/path','$2y$10$Rgd.2UclZ6nlsIzDtRegvOcmc3yfs7EykWamVm945Bhro4i/aFLvC','2023-06-12 17:20:58','2023-06-12 17:20:58'),
...
DROP TABLE IF EXISTS `form_bimbingan`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `form_bimbingan` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_form_bimbingan_mahasiswa` (`mahasiswa_id`),
  CONSTRAINT `fk_form_bimbingan_mahasiswa` FOREIGN KEY (`mahasiswa_id`) REFERENCES `mahasiswa` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `form_bimbingan` WRITE;
/*!40000 ALTER TABLE `form_bimbingan` DISABLE KEYS */;
INSERT INTO `form_bimbingan` VALUES
...
/*!40000 ALTER TABLE `form_bimbingan` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `form_evaluasi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `form_evaluasi` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_form_evaluasi_form_bimbingan` (`form_bimbingan_id`),
  CONSTRAINT `fk_form_evaluasi_form_bimbingan` FOREIGN KEY (`form_bimbingan_id`) REFERENCES `form_bimbingan` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `form_evaluasi` WRITE;
/*!40000 ALTER TABLE `form_evaluasi` DISABLE KEYS */;
INSERT INTO `form_evaluasi` VALUES
(1,'2023-06-23','Lose Streak',NULL,'2023-06-23 13:05:38','2023-06-23 13:05:38',3),
(2,'2023-06-30','Win Streak',NULL,'2023-06-23 13:07:13','2023-06-23 13:07:13',2),
(3,'2023-06-27','Sg twng',NULL,'2023-06-23 13:10:38','2023-06-23 13:10:38',11);
/*!40000 ALTER TABLE `form_evaluasi` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `kaprodi` VALUES
('1','Ani Usyi Laksmiwati','RPL','Elektro','/path','$2y$10$QUcqnO.9vOtpaE0OWkNkHO39NuFAedFxU94D4dODCYT3VojYvRQUS','2023-06-12 17:05:43','2023-06-12 17:05:43'),
...
CREATE TABLE `mahasiswa` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_mahasiswa_dosen` (`dosen_id`),
  KEY `fk_mahasiswa_kaprodi` (`kaprodi_id`),
  CONSTRAINT `fk_mahasiswa_dosen` FOREIGN KEY (`dosen_id`) REFERENCES `dosen` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  CONSTRAINT `fk_mahasiswa_kaprodi` FOREIGN KEY (`kaprodi_id`) REFERENCES `kaprodi` (`id`) ON DELETE SET NULL ON UPDATE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('123','Apriana','9496 Sauer Brooks Suite 237Port Leone, RI 43606','086208426881','Elektro','D2 AJK','/path','Mrs. Reuben Wolff','762 Bashirian Extension Suite 154Monahanborough, SC 63679-4818','083891295976','$2y$10$WeC8aWo7.E4.zPLttHo7y.xSaptnoqxdREeaBC0Py78vyrrlJJJXq','2023-06-12 17:22:42','2023-06-21 11:22:50','19','6'),
('2115354018','Domenick Feil','802 Eric Loaf Suite 063\nPort Paulview, WY 90231-6476','086984965065','Elektro','D2 AJK','/path','Mrs. Fabian Cronin','198 Bergnaum Radial\nEast Selenamouth, MD 43255','087051522044','$2y$10$GjOYZQOq8qpbWcbTFqpxEeJGNEw3kUlooXy0AUIkDzqEN9sm5KUL.','2023-06-12 17:22:36','2023-06-12 17:22:36','19','4'),
...
-- Dump completed on 2023-07-03 17:14:41
